    ...
    const config = {
        ...
        defaultConfig: [
            ...
            },
            {
                ...
                note: "Set a keyboard shortcut for opening the popout.",
                value: [162, 74]
            }
        ]
    };
    return !global.ZeresPluginLibrary ? class {
        ...
        : (([Plugin, Api]) => {
            const plugin = (Plugin, Api) => {
                ...
                const popoutSelector = DiscordSelectors.UserPopout.userPopout || (Logger.warn("Popout selector missing") || '[id^=popout_]');
                ...
                return class PanelPopout extends Plugin {
                    ...
                    openPopout() {
                        ...
                        try {
                            const container = (this.settings.position === 'top' || this.settings.position === 'bottom') ? document.querySelector(containerSelector) : this.avatar;
